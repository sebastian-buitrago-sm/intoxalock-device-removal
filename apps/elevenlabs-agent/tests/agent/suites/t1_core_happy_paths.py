...
def build(save_tool_id: str) -> list[TestsCreateRequestBody]:
    ...
    t1_1_sim = TestsCreateRequestBody_Simulation(
        ...
        simulation_scenario=(
            ...
            f"When she asks what the device removal would cost for the vehicle, say it is "
            f"${QUOTE}. "
        ...
        success_condition=(
            f"The agent confirmed the appointment for '{SLOT_1}', obtained a device removal "
    ...
    t1_2_sim = TestsCreateRequestBody_Simulation(
        ...
        success_condition=(
            ...
            f"'{SLOT_2}' instead, obtained a device removal quote of ${QUOTE}, called "
    ...
    t1_3_sim = TestsCreateRequestBody_Simulation(
        ...
        success_condition=(
            ...
            f"them as a confirmed appointment, obtained a device removal quote of ${QUOTE}, "
    ...
    t1_5_sim = TestsCreateRequestBody_Simulation(
        ...
        success_condition=(
            ...
            f"appointment and without fabricating a second alternative, called save_call_result "
            f"with shop_suggested_slot_1 populated and shop_suggested_slot_2 EMPTY, obtained a "
            f"device removal quote of ${QUOTE}, called save_call_result before closing, then "
            "called end_call to end the call politely without misunderstandings."
        ),
    )
    ...
    t1_4_sim = TestsCreateRequestBody_Simulation(
        name=slug_name("t1_4__simulation", "scheduling contact is not available"),
        dynamic_variables=DYNAMIC_VARS,
        simulation_scenario=(
            "You are an employee at a vehicle service center who just answered the phone. "
            "Daisy is calling to schedule a device removal appointment. "
        ...
        simulation_max_turns=15,
        success_condition=(
            "The agent was told the scheduling contact was not available, did NOT ask for a "
            "device removal quote, called save_call_result with all four slot/quote fields empty "
